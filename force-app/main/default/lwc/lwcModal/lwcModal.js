 ...
 * @changelog         : 2022-04-10 - Initial version
 *                      2022-08-12 - Rename files (WARNING: look out with any any custom modifications done inside the files)
 *                                 - Only scroll to top on mobile devices
 *                                 - keepFooterButtons option
 *                      2022-08-24 - fix slot content
 *                      2022-11-21 - disable pull to refresh
 **/
 ...
 export default class LwcModal extends LightningElement {
   ...
   /**
    * https://developer.salesforce.com/docs/component-library/documentation/en/lwc/lwc.mobile_disable_pull_to_refresh_in_the_mobile_app
    * This has an effect only in the Salesforce Mobile and Mobile Publisher apps
    */
   _disablePullToRefresh () {
       // CustomEvent is standard JavaScript. See: https://developer.mozilla.org/en-US/docs/Web/API/CustomEvent/CustomEvent
